    ...
    e.a = (function (t) {
      setInterval(function () {
        ...
        if ($("ol.chat li:last-child").attr("class") === "visitor") {
          $("ol.chat").append(
            '<li class="indicator"><div class="loading-dots"><span class="dot"></span><span class="dot"></span><span class="dot"></span></div></li>'
          );
          setTimeout(() => {
            $("#messageArea").animate({
          ...
          if (
            $("ol.chat li:last-child").attr("class") === "indicator" &&
            $("ol.chat li:nth-last-child(2)").attr("class") === "chatbot"
          ) {
...
function config_titulo_mensaje(mensajes) {
  ...
  setTimeout(() => {
    mensajes.forEach(function (mensaje, index) {
      var titlemessage = mensaje.from == "visitor" ? "Tú" : "Bernardino";
